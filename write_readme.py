# write_readme.py — README.md එක නිවැරදි full version එකෙන් ලියයි.
# setup_prakruthi.py run වෙලා README එක පරණ වුණොත් මේක ආයෙ run කරන්න.
import pathlib

README = """# ප්‍රකෘති AI — Prakruthi Sila Guardrail
...
print("README.md updated -", len(README.splitlines()), "lines")